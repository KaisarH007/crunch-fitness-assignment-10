...
const About = () => {
  return (
    <div className="home-bg text-white">
      <div className="about-banner text-center  d-flex align-items-center justify-content-center text-white ">
        <div>
          <h1 className="title-styel">NO JUDGMENTS</h1>
        </div>
      </div>
          ...
          <div className="col-md-6  d-flex align-items-center justify-content-center">
            <div>
              ...
              <p>
                ...
                nurturers. We seek only to encourage, empower and entertain.
                There is no one type. There is no one reason. There is no one
                way. What we are is a diverse community; what we have is a
                culture of fun; what there is, is room for everyone: all kinds
                of people with all kinds of goals who’ve chosen to come reach
                them with us. Crunch. No Judgments.
              </p>
            </div>
          </div>
